...
final Color appMaterialLightPrimarySurfaceColor =
    appMaterialLightColorScheme.primary;
// ignore: prefer-correct-identifier-length
final Color appMaterialLightOnPrimarySurfaceColor =
    appMaterialLightColorScheme.onPrimary;
// ignore: prefer-correct-identifier-length
final Color appMaterialDarkPrimarySurfaceColor =
    appMaterialLightColorScheme.surface;
// ignore: prefer-correct-identifier-length
...
final Color appMaterialLightCanvasColor =
...
// ignore: prefer-correct-identifier-length
final Color appMaterialLightBottomAppBarColor =
    appMaterialLightColorScheme.surface;
// ignore: prefer-correct-identifier-length
final Color appMaterialDarkBottomAppBarColor =
    appMaterialDarkColorScheme.surface;
...
// ignore: prefer-correct-identifier-length
final Color appMaterialLightBackgroundColor =
    appMaterialLightColorScheme.background;
final Color appMaterialDarkBackgroundColor =
    appMaterialDarkColorScheme.background;
...
final Color appMaterialLightHintColor =
    appMaterialLightColorScheme.inversePrimary;
final Color appMaterialDarkHintColor =
    appMaterialDarkColorScheme.inversePrimary;
