...
double? _getTargetRadius(
  ...
  if (containedInkWell) {
    ...
    return _getSplashRadiusForPositionInSize(
      size,
      position,
    );
  }
...
double? _getSplashRadiusForPositionInSize(
  Size bounds,
  Offset position,
) {
...
class WaveSplash extends InteractiveInkFeature {
  ...
  /// or material [Theme].
  static const InteractiveInkFeatureFactory splashFactory = _WaveSplashFactory(
    30,
    5,
  );
